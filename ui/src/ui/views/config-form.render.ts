...
export const SECTION_META: Record<string, { label: string; description: string }> = {
  ...
  diagnostics: { label: "诊断", description: "诊断工具和健康检查" },
  nodeHost: { label: "节点宿主", description: "节点宿主配置和管理" },
  media: { label: "媒体", description: "媒体处理和管道设置" },
  approvals: { label: "审批", description: "审批流程和权限控制" },
  memory: { label: "记忆", description: "记忆存储和上下文管理" },
};
