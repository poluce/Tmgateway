  ...
  return html`
    <section class="grid grid-cols-2">
      <div class="card">
        ...
        <div class="card-sub">网关拥有的 Cron 调度器状态。</div>
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            ...
            <div class="stat-value">${props.status?.jobs ?? "无"}</div>
          </div>
          <div class="stat">
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="card-sub">${props.runsJobId ?? "（选择一个任务）"}的最新运行记录。</div>
      ${
    ...
    <div class=${itemClass} @click=${() => props.onLoadRuns(job.id)}>
      <div class="list-main">
        ...
        <div class="chip-row" style="margin-top: 6px;">
          ...
          <span class="chip">${job.sessionTarget === "main" ? "主会话" : "隔离会话"}</span>
          <span class="chip">${job.wakeMode === "now" ? "立即" : "下次心跳"}</span>
        </div>
      </div>
      <div class="list-meta">
